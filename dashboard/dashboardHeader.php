...
$query = mysqli_query($dbConnect, $user);
    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout col-lg-12 col-12 p-0 fixed-top d-flex align-items-top flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                ...
                <div>
                    <a class="navbar-brand brand-logo" href="/stuxnet/dashboard/dashboard.php">
                    <h2 style="font-weight: bold" class="text-center"><span style="color: blue;">Stux</span>net</h2>
            ...
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
                        <h1 class="welcome-text">Hi, <span class="text-black fw-bold">John Doe</span></h1>
                        <h3 class="welcome-sub-text">Welcome to Dashboard.</h3>
                    </li>
                </ul>
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            ...
                            <a href="signOut.php" class="dropdown-item"><i class="dropdown-item-icon mdi mdi-power text-primary me-2"></i>Sign Out</a>
                        </div>
                    </li>
                </ul>
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/stuxnet/dashboard/dashboard.php">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="/stuxnet/dashboard/userList.php">User List</a></li>
